...
import YouTubeNotes from "./note.jsx";
...
function extractYouTubeId(urlOrId) {
  try {
    ...
    return urlOrId; // ถ้าไม่ใช่ URL ให้ถือว่าเป็น id ตรง ๆ
  }
  return urlOrId;
}
          ...
          <div className="p-4 md:p-6 flex justify-center">
            <div className="w-full max-w-6xl">
              ...
              <div className="rounded-lg  overflow-hidden bg-white ">
                {/* ส่งทั้ง videoId และ videoUrl (เผื่อใช้ในอนาคต) */}
                <YouTubeNotes key={currentLesson.id} videoId={currentVideoId} videoUrl={currentLesson.videoUrl} />
              </div>
            </div>
          </div>
        </main>
